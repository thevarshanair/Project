...
<body class="hold-transition skin-green sidebar-mini">
	<div class="wrapper">
		...
		<header class="main-header">
			...
			<!-- Logo -->
			<a href="index.php" class="logo logo-bg"> <!-- mini logo for sidebar mini 50x50 pixels -->
				<span class="logo-mini"><b>EJH</b>P</span> <!-- logo for regular state and mobile devices -->
							...
							<div class="row">
								<form method="post" action="addpost.php">
									...
									<div class ="form-div1">
											...
											<?php echo $_POST["jobfunction"]?>	</label>			
											</div>	
										</div>
