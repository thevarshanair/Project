...
if(isset($_POST)) {
	...
	//Encrypt Password
	$passwordcd = base64_encode(strrev(md5($password)));
	
	
	//$companyname, $contactno, $website, $email, $password, $streetaddress,$country,$state, $city,  $aboutme, $firstname, $lastname, $jobtitle, $password
	//companyname, contactno, website, email, password, streetaddress,country,state, city, aboutme, firstname, lastname, jobtitle, password
	...
	if($result->num_rows == 0) {
		...
		$sql = "INSERT INTO company(companyname, contactno, website, email, streetaddress,country,state, city, aboutme, firstname, lastname, jobtitle, password, logo) VALUES ('$companyname', '$contactno', '$website', '$email', '$streetaddress','$country','$state', '$city', '$aboutme', '$firstname', '$lastname', '$jobtitle', '$passwordcd', '$file')";
