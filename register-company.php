        ...
        <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
          ...
          <form method="post" id="registerCompanies" action="addcompany.php" enctype="multipart/form-data">
            <div class="col-md-6 latest-job ">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="streetaddress" placeholder="Street Address" required>
              </div>
              ...
              <div class="form-group">
                <textarea class="form-control input-lg" rows="4"  name="aboutme" placeholder="About yourself"></textarea>
              </div>
              <div class="form-group">
              ...
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="phonenumber" placeholder="Phone Number">
              </div>
              <div class="form-group">
                <input class="form-control input-lg" type="text" name="jobtitle" placeholder="Your Job Title">
              </div>
