      ...
      <div class="container">
        <div class="row">          
          <div class="col-md-9 bg-white padding-2">
            ...
            <hr>
            <div>
              <p><span class="margin-right-10"><i class="fa fa-location-arrow text-green"></i> <?php echo $row['city']; ?><i class="fa fa-location-arrow text-green"></i> <?php echo $row['subcategorytype']; ?></span> <i class="fa fa-calendar text-green"></i> <?php echo date("d-M-Y", strtotime($row['createdat'])); ?></p>              
            </div>
            <div>
