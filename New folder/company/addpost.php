...
if(isset($_POST)) {
    ...
    ******/
    ...
    jobtype, minimumsalary, maximumsalary,negotiable, postdate, startdate, name, email, contactno, streetaddress, appdeadline, degree, major, experience, description) VALUES ('$_SESSION['id_company']', '$healthcaresector', '$healthcaresector_employer', '$jobfunction', '$jobtitle', '$companyname', '$countries', '$states', '$cities', '$zipcode' ,
     ...
     * ****/
     ...
     $stmt = $conn->prepare("INSERT INTO job_post(id_company,healthcaresector, healthcaresector_employer, jobfunction, jobtitle, countries, states, cities, zipcode,
    jobtype, minimumsalary, maximumsalary,negotiable, postdate, startdate, streetaddress, appdeadline,
    degree, major, experience, description) VALUES (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)");
    
    $stmt->bind_param("issssssssssssssssssss", $_SESSION['id_company'], $healthcaresector, $healthcaresector_employer, $jobfunction, $jobtitle, $countries, $states, $cities, $zipcode,
        $jobtype, $minimumsalary, $maximumsalary, $negotiable, $postdate, $startdate, $streetaddress, $appdeadline,
        $degree, $major, $experience, $description);
